...
\begin{exercise} \label{e2.1.3}
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \draw[domain=0:90,samples=100]
            plot ({cos(\x)+((0.01745 * \x) * sin(\x))},{sin(\x)-((0.01745 * \x)^2-(0.01745 * \x * sin(\x))^2)^(0.5)}); % 0 <= theta <= pi/2
            
            \draw[domain=90:270,samples=100]
            plot ({cos(\x)+((0.01745 * \x) * sin(\x))},{sin(\x)+((0.01745 * \x)^2-(0.01745 * \x * sin(\x))^2)^(0.5)}); % pi/2 <= theta <= 3pi/2
            
            \draw[domain=270:360,samples=100]
            plot ({cos(\x)+((0.01745 * \x) * sin(\x))},{sin(\x)-((0.01745 * \x)^2-(0.01745 * \x * sin(\x))^2)^(0.5)}); % 3pi/2 <= theta <= 2pi
        \end{tikzpicture}
    \end{center}
    ...
    \begin{proof}
        ...
        \begin{center}
            \begin{tikzpicture}
                ...
                \draw[domain=90:150,samples=100]
                plot ({cos(\x)+((0.01745 * \x) * sin(\x))},{sin(\x)+((0.01745 * \x)^2-(0.01745 * \x * sin(\x))^2)^(0.5)}); % pi/2 <= theta <= 3pi/2
            \end{tikzpicture}
        \end{center}
    \end{proof}
